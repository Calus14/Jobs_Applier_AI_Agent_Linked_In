...
class ResumeGenerator:
    ...
    def create_resume_for_job_posting(self, style_path: str, job_description_text: str):
    ...
    def create_cover_letter_for_job_posting(self, style_path: str, job_description_text: str):
