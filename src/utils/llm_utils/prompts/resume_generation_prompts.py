# Used as a template to generate different component which will be rendered as HTML and then use a LLM to generate
# HTML with appropriate wording and info, then uses webdrivers to generate a pdf
